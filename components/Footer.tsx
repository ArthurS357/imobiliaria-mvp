                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 text-center md:text-left">
                    ...
                    <div className="border-t border-gray-800 pt-6 md:border-0 md:pt-0">
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link href="/imoveis" className="hover:text-white transition">Buscar Imóveis</Link></li>
                            ...
                            <li><Link href="/admin/login" className="text-blue-400 hover:text-white transition font-medium">Área do Corretor</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="hidden md:block"> {/* Ocultar categorias no mobile para economizar espaço? Ou manter: */}
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link href="/imoveis?tipo=Comercial" className="hover:text-white transition">Comercial</Link></li>
                        </ul>
                    </div>
