      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex gap-3">
            <Link
              href="/admin"
              className="text-gray-600 dark:text-gray-300 hover:text-blue-900 dark:hover:text-blue-400 flex items-center gap-2 font-medium px-4 py-2 border dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition shadow-sm"
            >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-600">
                  <tr>
                    <th className="p-4 font-semibold text-gray-600 dark:text-gray-300 text-sm uppercase">
                      Nome
                    </th>
                    <th className="p-4 font-semibold text-gray-600 dark:text-gray-300 text-sm uppercase">
                      Email
                    ...
                    <th className="p-4 font-semibold text-gray-600 dark:text-gray-300 text-sm uppercase text-right">
                      Ações
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                  {filteredUsers.map((user) => (
                    <tr
                      key={user.id}
                      className="hover:bg-gray-50 dark:hover:bg-gray-750 transition group"
                    >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8 w-full max-w-lg border border-gray-100 dark:border-gray-700 relative">
              ...
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white flex items-center gap-2">
                  <UserPlus className="text-blue-900 dark:text-blue-400" />{" "}
                  Criar Conta
                </h2>
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 p-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 dark:text-white"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-1">
                    <MailCheck size={12} /> Enviada por e-mail.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={newUser.creci}
                        onChange={(e) =>
                          setNewUser({ ...newUser, creci: e.target.value })
                        }
                        className="w-full pl-10 p-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 dark:text-white"
                        placeholder="12345-F"
                      />
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full p-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 dark:text-white h-[42px]"
                    >
                ...
                <div className="flex justify-end gap-3 mt-6 pt-4 border-t dark:border-gray-700">
                  <button
                    type="button"
                    onClick={() => setShowCreateModal(false)}
                    className="px-5 py-2.5 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg font-medium transition"
                  >
                    Cancelar
                  </button>
                  <button
                    type="submit"
                    disabled={creating}
                    className="px-6 py-2.5 bg-blue-900 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-800 font-bold transition flex items-center gap-2 disabled:opacity-70 min-w-[140px] justify-center shadow-md"
                  >
                    {creating ? (
                      <>
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 w-full max-w-md border border-gray-200 dark:border-gray-700 relative">
              ...
              <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-white flex items-center gap-2">
                <Edit size={20} className="text-blue-900 dark:text-blue-400" />{" "}
                Editar Usuário
              </h2>
              <form onSubmit={handleUpdate} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditingUser({ ...editingUser, creci: e.target.value })
                    }
                    className="w-full p-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div className="flex justify-end gap-2 mt-6 pt-4 border-t dark:border-gray-700">
                  ...
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="px-4 py-2 bg-blue-900 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition flex items-center gap-2 disabled:opacity-70 min-w-[100px] justify-center shadow-md"
                  >
                    {isSaving ? (
                      <>
